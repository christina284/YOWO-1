...
def parse_opts():
    ...
    # parser.add_argument('--dataset', default='tiger', type=str, help='Select dataset from (ucf101-24, jhmdb-21)')
    ...
    parser.add_argument('--resume_path', default='/mnt/terabyte/chris_data/repos/YOWO/backup/yowo_ucf101-24_16f_best.pth', type=str, help='Continue training from pretrained (.pth)')
    parser.add_argument('--data_cfg', default='cfg/ucf24.data', type=str, help='Configuration related to data')
    parser.add_argument('--cfg_file', default='cfg/ucf24.cfg', type=str, help='Configuration file')
    parser.add_argument('--backbone_3d', default='resnet18', type=str, help='(resnext101 | resnet101 | resnet50 | resnet18 | mobilenet_2x | mobilenetv2_1x | shufflenet_2x | shufflenetv2_2x')
    ...
    parser.add_argument('--video_path', default='', help='Path to video for inference')
